...
Save the Code: Ensure your source code is saved as student_manager.c in your working directory.

Compile: Open your terminal/command prompt and run the standard GCC command. We're compiling it into an executable named manager:
